...
class WebSocketLike(Protocol):
    """Anything Exotel media frames can be pushed through.

    Production passes the real FastAPI WebSocket; tests pass a mock with the
    same send shape. Only `send_text` is ever used on it.
    """
...
class StreamSession:
    ...
    async def safe_send_text(self, websocket: WebSocketLike, message: str) -> bool:
        """
